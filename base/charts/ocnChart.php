<?php
	...
	try {		
		...
		foreach($dbh->query($sqlSelect) as $data){
			...
			if($first){
				$frontStr .= "\n[new Date(" . $year . "," . $month . "," . $day . "), " . $sumArr['chlorophyll']   . "," . $sumArr['dissolvedOxygen']   . ", " . $sumArr['oceanCurrents']   . ", " . $sumArr['salinity']   . ", " . $sumArr['solar'] . ", " . $sumArr['turbidity'] . ", " . $sumArr['waterLevel'] . ", " . $sumArr['waterTemperature']   . "]";
				$first = false;
			}
			else{
				$frontStr .= "\n,[new Date(" . $year . "," . $month . "," . $day . "), " . $sumArr['chlorophyll']   . "," . $sumArr['dissolvedOxygen']   . ", " . $sumArr['oceanCurrents']   . ", " . $sumArr['salinity']   . ", " . $sumArr['solar'] . ", " . $sumArr['turbidity'] . ", " . $sumArr['waterLevel'] . ", " . $sumArr['waterTemperature']   . "]";
