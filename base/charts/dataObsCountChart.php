...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			google.load('visualization', '1', {'packages':['annotatedtimeline', 'controls']});
			...
			function drawChart(){
				...
				<?php		
					...
					foreach($dbh->query($sqlSelect) as $data){
						...
						if($first){
							$frontStr .= "\n[new Date(" . $year . "," . $month . "," . $day . "), " . $sumArr['airPressure'] / 1000 . "," . $sumArr['airTemperature'] / 1000 . ", " . $sumArr['chlorophyll'] / 1000 . ", " . $sumArr['dewPoint'] / 1000 . ", " . $sumArr['dissolvedOxygen'] / 1000 . ", " . $sumArr['oceanCurrents'] / 1000 . ", " . $sumArr['relHumidity'] / 1000 . ", " . $sumArr['salinity'] / 1000 . ", " . $sumArr['solar'] / 1000 . ", " . $sumArr['turbidity'] / 1000 . ", " . $sumArr['waterLevel'] / 1000 . ", " . $sumArr['waterTemperature'] / 1000 . ", " . $sumArr['winds'] / 1000 . "]";
							$first = false;
						}
						else{
							$frontStr .= "\n,[new Date(" . $year . "," . $month . "," . $day . "), " . $sumArr['airPressure'] / 1000 . "," . $sumArr['airTemperature'] / 1000 . ", " . $sumArr['chlorophyll'] / 1000 . ", " . $sumArr['dewPoint'] / 1000 . ", " . $sumArr['dissolvedOxygen'] / 1000 . ", " . $sumArr['oceanCurrents'] / 1000 . ", " . $sumArr['relHumidity'] / 1000 . ", " . $sumArr['salinity'] / 1000 . ", " . $sumArr['solar'] / 1000 . ", " . $sumArr['turbidity'] / 1000 . ", " . $sumArr['waterLevel'] / 1000 . ", " . $sumArr['waterTemperature'] / 1000 . ", " . $sumArr['winds'] / 1000 . "]";
				...
				annotatedtimeline.draw(data, {'displayAnnotations': true, 'legendPosition': 'newRow'});
			}
		</script>
	</head>
	<body>
		<div id="visualization" style="width: 1024px; height: 512px;"></div>
	</body>
</html>